# MII PR Mikrobio Bartlett Score - MII Implementation Guide Microbiology v2027.0.0-ballot2

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MII PR Mikrobio Bartlett Score**

## Resource Profile: MII PR Mikrobio Bartlett Score 

| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/modul-mikrobio/StructureDefinition/mii-pr-mikrobio-bartlett-score | *Version*:2027.0.0-ballot2 |
| Active as of 2026-09-14 | *Computable Name*:MII_PR_Mikrobio_Bartlett_Score |
...
Bartlett score describes the qualitative microscopic assessment of the suitability of sputum specimens for microbiological culture, based on the ratio of inflammatory cells to epithelial cells.

### Examples

Example (minimal):

[mii-exa-mikrobio-bartlett-score](Observation-mii-exa-mikrobio-bartlett-score.md)

**Usages:**

* Refer to this Profile: [MII PR Mikrobio Diagnostic Report](StructureDefinition-mii-pr-mikrobio-diagnostic-report.md)
* Examples for this Profile: [Observation/mii-exa-mikrobio-bartlett-score](Observation-mii-exa-mikrobio-bartlett-score.md)
* CapabilityStatements using this Profile: [MII CPS Mikrobio Metadata](CapabilityStatement-mii-cps-mikrobio-metadata.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.medizininformatikinitiative.kerndatensatz.mikrobiologie|current/StructureDefinition/StructureDefinition-mii-pr-mikrobio-bartlett-score.json)
...
Other representations of profile: [CSV](../StructureDefinition-mii-pr-mikrobio-bartlett-score.csv), [Excel](../StructureDefinition-mii-pr-mikrobio-bartlett-score.xlsx), [Schematron](../StructureDefinition-mii-pr-mikrobio-bartlett-score.sch) 
...
```json
{
  ...
  "url" : "https://www.medizininformatik-initiative.de/fhir/modul-mikrobio/StructureDefinition/mii-pr-mikrobio-bartlett-score",
  "version" : "2027.0.0-ballot2",
  "name" : "MII_PR_Mikrobio_Bartlett_Score",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "extensible",
        "valueSet" : "https://www.medizininformatik-initiative.de/fhir/modul-mikrobio/ValueSet/mii-vs-mikrobio-bartlett-score-loinc"
      }
    },
    {
