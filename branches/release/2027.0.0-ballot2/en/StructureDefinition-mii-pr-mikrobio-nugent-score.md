# MII PR Mikrobio Nugent Score - MII Implementation Guide Microbiology v2027.0.0-ballot2

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MII PR Mikrobio Nugent Score**

## Resource Profile: MII PR Mikrobio Nugent Score 

| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/modul-mikrobio/StructureDefinition/mii-pr-mikrobio-nugent-score | *Version*:2027.0.0-ballot2 |
| Active as of 2026-09-14 | *Computable Name*:MII_PR_Mikrobio_Nugent_Score |
...
Other representations of profile: [CSV](../StructureDefinition-mii-pr-mikrobio-nugent-score.csv), [Excel](../StructureDefinition-mii-pr-mikrobio-nugent-score.xlsx), [Schematron](../StructureDefinition-mii-pr-mikrobio-nugent-score.sch) 
