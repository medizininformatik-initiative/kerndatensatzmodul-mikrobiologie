# MII PR Mikrobio CT Wert - MII Implementation Guide Microbiology v2027.0.0-ballot2

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MII PR Mikrobio CT Wert**

## Resource Profile: MII PR Mikrobio CT Wert 

| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/modul-mikrobio/StructureDefinition/mii-pr-mikrobio-ct-wert | *Version*:2027.0.0-ballot2 |
| Active as of 2026-09-14 | *Computable Name*:MII_PR_Mikrobio_Ct_Wert |
...
The Ct value is a supporting measurement, not a step of its own, and the relationship to the qualitative result read from it is recorded on that result: the detection carries `derivedFrom` pointing at the Ct value, never the Ct value at the detection. `A.derivedFrom = B` means "A arises from B“, and it is the detection that arises from the measurement.

`derivedFrom` is Must Support at this profile all the same, for the case where a Ct value itself arises from a preceding investigation. The pairing is shown by [mii-exa-mikrobio-spezifische-bestimmung-influenza-positiv](Observation-mii-exa-mikrobio-spezifische-bestimmung-influenza-positiv.md), which points at the Ct value example: `49524-2` and `74039-9` differ only in property and scale — the same component, the same specimen-neutral system, the same method. One investigation, two statements reported from it. [Profile Selection and Delimitation](profilauswahl-und-abgrenzung.md) shows the chain as a whole.
...
* Examples for this Profile: [Observation/mii-exa-mikrobio-ct-wert](Observation-mii-exa-mikrobio-ct-wert.md)
* CapabilityStatements using this Profile: [MII CPS Mikrobio Metadata](CapabilityStatement-mii-cps-mikrobio-metadata.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.medizininformatikinitiative.kerndatensatz.mikrobiologie|current/StructureDefinition/StructureDefinition-mii-pr-mikrobio-ct-wert.json)
...
Other representations of profile: [CSV](../StructureDefinition-mii-pr-mikrobio-ct-wert.csv), [Excel](../StructureDefinition-mii-pr-mikrobio-ct-wert.xlsx), [Schematron](../StructureDefinition-mii-pr-mikrobio-ct-wert.sch) 
...
```json
{
  ...
  "url" : "https://www.medizininformatik-initiative.de/fhir/modul-mikrobio/StructureDefinition/mii-pr-mikrobio-ct-wert",
  "version" : "2027.0.0-ballot2",
  "name" : "MII_PR_Mikrobio_Ct_Wert",
  "title" : "MII PR Mikrobio CT Wert",
  "status" : "active",
  "experimental" : false,
  "date" : "2026-09-14T18:09:48+00:00",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "extensible",
        "valueSet" : "https://www.medizininformatik-initiative.de/fhir/modul-mikrobio/ValueSet/mii-vs-mikrobio-ct-wert-loinc"
      }
    },
    {
