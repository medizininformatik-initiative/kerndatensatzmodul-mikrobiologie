# MII PR Mikrobio Allgemeine Kultur - MII Implementation Guide Microbiology v2027.0.0-ballot2

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MII PR Mikrobio Allgemeine Kultur**

## Resource Profile: MII PR Mikrobio Allgemeine Kultur 

| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/modul-mikrobio/StructureDefinition/mii-pr-mikrobio-allgemeine-kultur | *Version*:2027.0.0-ballot2 |
| Active as of 2026-09-14 | *Computable Name*:MII_PR_Mikrobio_Allgemeine_Kultur |
...
The general culture is normally the first step: it establishes that something grows, not what it is. Naming the organism is a separate investigation — [General determination](StructureDefinition-mii-pr-mikrobio-allgemeine-bestimmung.md) — which points back at this culture through the `triggeredBy` extension with `type = reflex`. The culture itself carries no reference to what follows it; the relationship is always recorded on the later investigation. [Profile Selection and Delimitation](profilauswahl-und-abgrenzung.md) shows the chain as a whole.
...
Other representations of profile: [CSV](../StructureDefinition-mii-pr-mikrobio-allgemeine-kultur.csv), [Excel](../StructureDefinition-mii-pr-mikrobio-allgemeine-kultur.xlsx), [Schematron](../StructureDefinition-mii-pr-mikrobio-allgemeine-kultur.sch) 
...
```json
{
  ...
  "url" : "https://www.medizininformatik-initiative.de/fhir/modul-mikrobio/StructureDefinition/mii-pr-mikrobio-allgemeine-kultur",
  "version" : "2027.0.0-ballot2",
  "name" : "MII_PR_Mikrobio_Allgemeine_Kultur",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "extensible",
        "valueSet" : "https://www.medizininformatik-initiative.de/fhir/modul-mikrobio/ValueSet/mii-vs-mikrobio-allgemeine-kultur-methode-snomed"
      }
    },
    {
