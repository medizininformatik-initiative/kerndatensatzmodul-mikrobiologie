# MII PR Mikrobio Voraussichtliche Empfindlichkeit - MII Implementation Guide Microbiology v2027.0.0-ballot2

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII PR Mikrobio Voraussichtliche Empfindlichkeit**

## Ressourcenprofil: MII PR Mikrobio Voraussichtliche Empfindlichkeit 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/modul-mikrobio/StructureDefinition/mii-pr-mikrobio-voraussichtliche-empfindlichkeit | *Version*:2027.0.0-ballot2 |
| Active Stand: 2026-09-14 | *Maschinenlesbarer Name*:MII_PR_Mikrobio_Voraussichtliche_Empfindlichkeit |
...
* Examples for this Profile: [Observation/mii-exa-mikrobio-voraussichtliche-empfindlichkeit](Observation-mii-exa-mikrobio-voraussichtliche-empfindlichkeit.md)
* CapabilityStatements using this Profile: [MII CPS Mikrobio Metadata](CapabilityStatement-mii-cps-mikrobio-metadata.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.medizininformatikinitiative.kerndatensatz.mikrobiologie|current/StructureDefinition/StructureDefinition-mii-pr-mikrobio-voraussichtliche-empfindlichkeit.json)
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-pr-mikrobio-voraussichtliche-empfindlichkeit.csv), [Excel](../StructureDefinition-mii-pr-mikrobio-voraussichtliche-empfindlichkeit.xlsx), [Schematron](../StructureDefinition-mii-pr-mikrobio-voraussichtliche-empfindlichkeit.sch) 
...
```json
{
  ...
  "url" : "https://www.medizininformatik-initiative.de/fhir/modul-mikrobio/StructureDefinition/mii-pr-mikrobio-voraussichtliche-empfindlichkeit",
  "version" : "2027.0.0-ballot2",
  "name" : "MII_PR_Mikrobio_Voraussichtliche_Empfindlichkeit",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://www.medizininformatik-initiative.de/fhir/modul-mikrobio/ValueSet/mii-vs-mikrobio-voraussichtliche-empfindlichkeit"
      }
    },
    {
