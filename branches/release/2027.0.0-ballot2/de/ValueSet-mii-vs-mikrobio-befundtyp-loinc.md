...
| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/modul-mikrobio/ValueSet/mii-vs-mikrobio-befundtyp-loinc | *Version*:2027.0.0-ballot2 |
| Active Stand: 2026-09-14 | *Maschinenlesbarer Name*:MII_VS_Mikrobio_Befundtyp_LOINC |
...
```json
{
  ...
  "compose" : {
    "include" : [{
      ...
      {
        "code" : "96397-5",
        "display" : "Microbiology - mycobacteriology studies Document"
      },
      {
        "code" : "96398-3",
        "display" : "Microbiology - mycology studies Document"
      },
      {
        "code" : "92892-9",
