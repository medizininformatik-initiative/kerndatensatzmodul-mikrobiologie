# Artifacts Summary - MII Implementation Guide Microbiology v2027.0.0-ballot2
...
| [ MII VS Mikrobio Aviditaet Ergebnis  ](ValueSet-mii-vs-mikrobio-aviditaet-ergebnis.md) | Bewertungs-ValueSet für die Avidität: kategoriale Einordnung des Aviditätsindex als niedrig, grenzwertig oder hoch. Niedrige Avidität spricht für eine frische Infektion. |
...
| [ MII VS Mikrobio Mikroskopie Gesichtsfeld Einheiten [UCUM]  ](ValueSet-mii-vs-mikrobio-mikroskopie-gesichtsfeld-einheiten-ucum.md) | Einheiten für die Zählung je Gesichtsfeld in der Mengenkomponente der Mikroskopie. |
| [ MII VS Mikrobio Mikroskopie Semiquantitativ [SNOMED]  ](ValueSet-mii-vs-mikrobio-mikroskopie-semiquantitativ-snomed.md) | Mengen-ValueSet der Mikroskopie: die semiquantitative Stufe, in der ein mikroskopischer Befund gesehen wurde. |
...
| [ MII VS Mikrobio Spezifische Mikroskopie Tests [LOINC]  ](ValueSet-mii-vs-mikrobio-spezifische-mikroskopie-tests-loinc.md) | Tests-ValueSet für die spezifische Mikroskopie: ordinale LOINC-Codes, bei denen das gesuchte Objekt und die Färbetechnik im Code benannt sind; das Ergebnis ist der Nachweis, die Menge steht in der Mengenkomponente. |
...
| [ MII EXA Mikrobio Spezifische Mikroskopie Kinyoun zwei plus  ](Observation-mii-exa-mikrobio-spezifische-mikroskopie-kinyoun-zweiplus.md) | Kinyounfärbung mit Nachweis säurefester Stäbchen, in der Stufe zwei von drei als Mengenkomponente — entsprechend 1–10 pro Gesichtsfeld. |
| [ MII EXA Mikrobio Spezifische Mikroskopie Leukozyten je Gesichtsfeld  ](Observation-mii-exa-mikrobio-spezifische-mikroskopie-leukozyten-gesichtsfeld.md) | Leukozyten im Grampräparat nachgewiesen, mit der Menge als Zählung je Gesichtsfeld — 10 bis 25 — statt als semiquantitative Stufe. |
