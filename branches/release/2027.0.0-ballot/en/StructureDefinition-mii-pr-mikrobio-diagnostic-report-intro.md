...
none of them. The HL7 EU Lab Semantic Workgroup puts it as "a serological report is often
more than the sum of its parts" and asks that the conclusion be exchangeable,
"free text to begin with".

`conclusionCode` is deliberately not constrained here. The HL7 EU Lab Semantic Workgroup proposes
