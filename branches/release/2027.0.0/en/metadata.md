# Metadata Overview - MII Implementation Guide Microbiology v2027.0.0-ballot2
...
| | | | |
| :--- | :--- | :--- | :--- |
| F1 | RDA-F1-01M | Metadata is identified by a persistent identifier | Canonical`url`values, the package id`de.medizininformatikinitiative.kerndatensatz.mikrobiologie`, the package version and`package-source`. Persistence depends on publication governance. |
