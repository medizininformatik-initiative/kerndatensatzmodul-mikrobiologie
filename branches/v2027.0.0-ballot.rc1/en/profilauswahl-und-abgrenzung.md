...
* [Specific microscopy](StructureDefinition-mii-pr-mikrobio-spezifische-mikroskopie.md) — the object is named in the code, the result is its detection, with the amount alongside
