# MII PR Mikrobio Barlett Score - MII Implementation Guide Microbiology v2027.0.0-ballot.rc1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MII PR Mikrobio Barlett Score**

## Resource Profile: MII PR Mikrobio Barlett Score 

| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/modul-mikrobio/StructureDefinition/mii-pr-mikrobio-barlett-score | *Version*:2027.0.0-ballot.rc1 |
| Active as of 2026-09-09 | *Computable Name*:MII_PR_Mikrobio_Barlett_Score |
...
Barlett score describes the qualitative microscopic assessment of the suitability of sputum specimens for microbiological culture, based on the ratio of inflammatory cells to epithelial cells.
...
* Examples for this Profile: [Observation/mii-exa-mikrobio-barlett-score](Observation-mii-exa-mikrobio-barlett-score.md)
* CapabilityStatements using this Profile: [MII CPS Mikrobio Metadata](CapabilityStatement-mii-cps-mikrobio-metadata.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.medizininformatikinitiative.kerndatensatz.mikrobiologie|current/StructureDefinition/StructureDefinition-mii-pr-mikrobio-barlett-score.json)
...
Other representations of profile: [CSV](../StructureDefinition-mii-pr-mikrobio-barlett-score.csv), [Excel](../StructureDefinition-mii-pr-mikrobio-barlett-score.xlsx), [Schematron](../StructureDefinition-mii-pr-mikrobio-barlett-score.sch) 
...
```json
{
  ...
  "url" : "https://www.medizininformatik-initiative.de/fhir/modul-mikrobio/StructureDefinition/mii-pr-mikrobio-barlett-score",
  "version" : "2027.0.0-ballot.rc1",
  "name" : "MII_PR_Mikrobio_Barlett_Score",
