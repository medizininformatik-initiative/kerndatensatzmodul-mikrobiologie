# MII EXA Mikrobio Allgemeine Kultur methodenneutraler Code - MII Implementation Guide Microbiology v2027.0.0-ballot.rc1

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MII EXA Mikrobio Allgemeine Kultur methodenneutraler Code**

## Example Observation: MII EXA Mikrobio Allgemeine Kultur methodenneutraler Code
...
Profile: [MII PR Mikrobio Allgemeine Kultur](StructureDefinition-mii-pr-mikrobio-allgemeine-kultur.md)

**identifier**: Observation Instance Identifier/allg-kultur-2
...
**method**: Microbial culture technique
...
```json
{
  ...
  "id" : "mii-exa-mikrobio-allgemeine-kultur-methodenneutral",
  "meta" : {
  ...
  "method" : {
    "coding" : [{
      ...
      "version" : "http://snomed.info/sct/900000000000207008/version/20260701",
      "code" : "702658000",
      "display" : "Microbial culture technique"
    }]
  },
  "specimen" : {
