...
* Ein siebtes Beispiel, `mii-exa-mikrobio-spezifische-bestimmung-influenza-positiv`, zeigt die Richtung von `derivedFrom`: Der Nachweis verweist auf den Ct-Wert, aus dem er abgelesen wurde. Bisher trug der Ct-Wert den Verweis, in der Gegenrichtung.
