# CodeSystems - MII Implementation Guide Microbiology v2027.0.0-ballot.rc1
...
Diese Seite listet die CodeSysteme, die das Modul **Mikrobiologie** selbst definiert (Namenskonvention `MII_CS_<Modul>_<Name>`). Sie decken ab, wofür in internationalen Terminologien kein passender Code existiert.
