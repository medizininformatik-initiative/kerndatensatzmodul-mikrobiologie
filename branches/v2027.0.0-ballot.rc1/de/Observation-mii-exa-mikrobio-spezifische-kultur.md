# mii-exa-mikrobio-spezifische-kultur - MII Implementation Guide Microbiology v2027.0.0-ballot.rc1

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **mii-exa-mikrobio-spezifische-kultur**

## Beispiel Observation: mii-exa-mikrobio-spezifische-kultur
...
**code**: Rotavirus identified in Specimen by Organism specific culture
...
```json
{
  ...
  "code" : {
    "coding" : [{
      "system" : "http://loinc.org",
      "code" : "6547-4",
      "display" : "Rotavirus identified in Specimen by Organism specific culture"
    }]
  },
  "subject" : {
