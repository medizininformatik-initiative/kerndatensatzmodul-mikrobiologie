...
- New examples, each documenting a case that was not representable before: [mii-exa-mikrobio-allgemeine-kultur-methodenneutral](Observation-mii-exa-mikrobio-allgemeine-kultur-methodenneutral.html) (the method-neutral culture code with its mandatory method), [mii-exa-mikrobio-mikroskopie-gram-kokken-wenig](Observation-mii-exa-mikrobio-mikroskopie-gram-kokken-wenig.html) (morphology plus amount as a component), [mii-exa-mikrobio-spezifische-mikroskopie-auramin-negativ](Observation-mii-exa-mikrobio-spezifische-mikroskopie-auramin-negativ.html) and [mii-exa-mikrobio-spezifische-mikroskopie-kinyoun-zweiplus](Observation-mii-exa-mikrobio-spezifische-mikroskopie-kinyoun-zweiplus.html) (acid-fast grades), [mii-exa-mikrobio-spezifische-mikroskopie-leukozyten-gesichtsfeld](Observation-mii-exa-mikrobio-spezifische-mikroskopie-leukozyten-gesichtsfeld.html) (a count per high power field), [mii-exa-mikrobio-empfindlichkeit-nur-kategorie](Observation-mii-exa-mikrobio-empfindlichkeit-nur-kategorie.html) (a category without a measurement) and [mii-exa-mikrobio-spezifische-bestimmung-influenza-positiv](Observation-mii-exa-mikrobio-spezifische-bestimmung-influenza-positiv.html), which shows the direction of `derivedFrom`: the detection points at the Ct value it was read from, where the reference previously sat on [mii-exa-mikrobio-ct-wert](Observation-mii-exa-mikrobio-ct-wert.html) and ran the other way. The microscopy examples are taken from a real laboratory result catalogue.
- The examples now share supporting resources instead of inlining them: [mii-exa-mikrobio-patient](Patient-mii-exa-mikrobio-patient.html), [mii-exa-mikrobio-labor](Organization-mii-exa-mikrobio-labor.html) as the performing laboratory, and [mii-exa-mikrobio-probe](Specimen-mii-exa-mikrobio-probe.html) with [mii-exa-mikrobio-probe-katheterspitze](Specimen-mii-exa-mikrobio-probe-katheterspitze.html) as specimens against the new Specimen profile.
...
- [mii-exa-mikrobio-spezifische-kultur](Observation-mii-exa-mikrobio-spezifische-kultur.html) reports `Detected` instead of `Organism growth`: a targeted culture answers whether the named target is there, and the culture itself is already stated by the test code.
...
- `mii-exa-mikrobio-mre-klasse` is dropped. New are two examples for the resistance category status, [mii-exa-mikrobio-resistenzkategorie-vre-positiv](Observation-mii-exa-mikrobio-resistenzkategorie-vre-positiv.html) and [mii-exa-mikrobio-resistenzkategorie-vre-negativ](Observation-mii-exa-mikrobio-resistenzkategorie-vre-negativ.html), representative of all categories; the negative examples [mii-exa-mikrobio-spezifische-bestimmung-vre-negativ](Observation-mii-exa-mikrobio-spezifische-bestimmung-vre-negativ.html) and [mii-exa-mikrobio-spezifische-kultur-vre-negativ](Observation-mii-exa-mikrobio-spezifische-kultur-vre-negativ.html); [mii-exa-mikrobio-mrgn-klasse-negativ](Observation-mii-exa-mikrobio-mrgn-klasse-negativ.html) for `keine-mrgn-klasse`; and the three-part chain [mii-exa-mikrobio-workflow-vre-01-kultur](Observation-mii-exa-mikrobio-workflow-vre-01-kultur.html) → [mii-exa-mikrobio-workflow-vre-02-identifikation](Observation-mii-exa-mikrobio-workflow-vre-02-identifikation.html) → [mii-exa-mikrobio-workflow-vre-03-empfindlichkeit](Observation-mii-exa-mikrobio-workflow-vre-03-empfindlichkeit.html) as the basis of the derivation.
