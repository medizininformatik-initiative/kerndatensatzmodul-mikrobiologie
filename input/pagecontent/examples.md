...
This page lists the example instances of the **Microbiology** module. The
template ships the synthetic example
the 27 example instances of this module, listed on the [Artifacts Summary](artifacts.html).
