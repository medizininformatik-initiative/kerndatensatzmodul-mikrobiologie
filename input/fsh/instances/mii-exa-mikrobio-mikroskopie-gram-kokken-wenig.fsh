...
//
// Der Code 664-3 nennt die Faerbung selbst. Sie steht trotzdem in
// extension[faerbung]: Auswertende finden sie damit an derselben Stelle wie bei
// 105059-0, ohne den Untersuchungscode interpretieren zu muessen.
