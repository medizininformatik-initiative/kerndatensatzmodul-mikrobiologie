...
* code.coding[+] = $loinc#92253-4 "Mikroorganismus identifiziert in Isolat oder Probenmaterial mittels Molekulargenetik"
* code.coding[+] = $loinc#96958-4 "SARS-CoV-2 (COVID-19) N-Gen [Nachweis] in Speichel mittels Nukleinsäureamplifikation mit Sondendetektion mit CDC-Primer-Sondenset N2"
