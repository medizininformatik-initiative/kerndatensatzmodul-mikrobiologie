...
Description: "This profile describes the type of multi-resistant organism"
* insert PR_CS_VS_Version
* insert Publisher
* ^purpose = "Dieses Profil beschreibt die MRE Klasse in der Medizininformatik-Initiative."
* obeys mii-lab-2
* id MS
* meta MS
  * source MS
...
* referenceRange MS
* component
  * code = $sct#117591009 "Infectious agent genotype identification (procedure)"
    * ^short = "Genotyp"
