Profile: MII_PR_Mikrobio_Resistenzmutation
Parent: Observation
...
* code MS
* code from MII_VS_Mikrobio_Resistenzmutation_LOINC (extensible)
* subject 1.. MS
* encounter MS
* effective[x] 1.. MS
...
* component MS
  ...
  * ^slicing.rules = #open
* component contains MicroorganismResistanceMutation 0..*
* component[MicroorganismResistanceMutation]
  * code = $loinc#92243-5
  * value[x] only CodeableConcept
  * value[x] from $microbigge (preferred)