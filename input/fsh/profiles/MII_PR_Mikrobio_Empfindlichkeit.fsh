...
// Terminologische Luecke (Issue #84): Fuer einen eigenstaendigen zielgerichteten Nachweis
// "Linezolid-resistant Enterococcus present?" existiert derzeit kein LOINC-Presence-Code.
// Bis dahin ist nur der Weg ueber die Empfindlichkeitstestung eines identifizierten
// Isolats moeglich. Externe SNOMED-Organism-Codes sind kein Ersatz fuer einen fehlenden
// Testcode, da Observation.code die Testfrage und nicht den Organismus ausdruecken soll.
