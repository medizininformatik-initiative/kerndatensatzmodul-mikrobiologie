...
Die 2027er Modellierung verwendet eigenständige Observation-Profile statt `component`-Abbildungen. Die Profile sind in vier Familien gegliedert; die Modellierungshinweise stehen auf [FHIR-Profile – Modellierungshinweise](fhir-profile.md), die Abgrenzung zwischen ihnen auf [Profilauswahl und Abgrenzung](profilauswahl-und-abgrenzung.md).
