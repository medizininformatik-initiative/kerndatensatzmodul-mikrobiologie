# MII EXA Mikrobio Bartlett Score - MII Implementation Guide Microbiology v2027.0.0-ballot.rc1

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII EXA Mikrobio Bartlett Score**

## Beispiel Observation: MII EXA Mikrobio Bartlett Score
...
Profile: [MII PR Mikrobio Bartlett Score](StructureDefinition-mii-pr-mikrobio-bartlett-score.md)

**identifier**: Observation Instance Identifier/bartlett-1
...
```json
{
  ...
  "id" : "mii-exa-mikrobio-bartlett-score",
  "meta" : {
